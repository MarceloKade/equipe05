...
export default function ModalForm({ handleModalFormClose }: ModalFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const sobrenomeElement = document.getElementById(
      "sobrenome"
    ) as HTMLInputElement;
    const emailElement = document.getElementById("email") as HTMLInputElement;
    const disponibilidadeElement = document.getElementById(
      "disponibilidade"
    ) as HTMLInputElement;

    // Obtendo os elementos dos menus dropdown
    const areaInteresseElement = document.getElementById(
      "areaDeInteresse"
    ) as HTMLSelectElement;
    const turnoElement = document.getElementById("turno") as HTMLSelectElement;
    const linguagemElement = document.getElementById(
      "linguagem"
    ) as HTMLSelectElement;
